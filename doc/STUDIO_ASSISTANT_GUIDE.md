...
If a workspace restore already has an assistant session binding, Studio rehydrates that session through the shared session runtime instead of keeping a blank local-only view.
