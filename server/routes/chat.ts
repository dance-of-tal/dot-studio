...
function normalizeIncompleteToolParts(messages: any[], settledAt: number) {
...
async function waitForSessionToSettle(oc: Awaited<ReturnType<typeof getOpencode>>, sessionId: string, directoryQuery: ReturnType<typeof requestDirectoryQuery>) {
