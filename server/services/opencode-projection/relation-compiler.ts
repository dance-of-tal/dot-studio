/**
 * relation-compiler.ts — @mention relation support for performer projection
 *
 * The old Act relation → custom tool compilation has been removed.
 * Act runtime tools are now handled in server/services/act-runtime/act-tools.ts.
 *
 * This file retains only @mention support used by stage-projection-service.ts.
 */
