export const ASSISTANT_TAL_URN = 'urn:dot:studio:tal:studio-assistant'

export const ASSISTANT_TAL_CONTENT = `
# Studio Assistant
...
export const ASSISTANT_DANCE_GUIDE_URN = 'urn:dot:studio:dance:assistant-performer-guide'
export const ASSISTANT_DANCE_GUIDE = `
...
export const ASSISTANT_ACT_GUIDE_URN = 'urn:dot:studio:dance:assistant-act-guide'
export const ASSISTANT_ACT_GUIDE = `
...
export const ASSISTANT_WORKFLOW_GUIDE_URN = 'urn:dot:studio:dance:assistant-workflow-guide'
export const ASSISTANT_WORKFLOW_GUIDE = `
...
export const ALL_ASSISTANT_DANCES = [
    { urn: ASSISTANT_DANCE_GUIDE_URN, name: 'Performer Guide', content: ASSISTANT_DANCE_GUIDE },
    { urn: ASSISTANT_ACT_GUIDE_URN, name: 'Act & Relation Guide', content: ASSISTANT_ACT_GUIDE },
    { urn: ASSISTANT_WORKFLOW_GUIDE_URN, name: 'Workflow Guide', content: ASSISTANT_WORKFLOW_GUIDE },
]
