        ...
        <div className="assets-panel">
            ...
            {controller.scope === 'local' ? (
                <AssetLibraryLocalView
                    ...
                    mcpDraftEntries={controller.mcpDraftEntries}
                    ...
                    resetMcpCatalog={controller.resetMcpCatalog}
                    connectMcpServer={controller.connectMcpServer}
                    disconnectMcpServer={controller.disconnectMcpServer}
                    authenticateMcpServer={controller.authenticateMcpServer}
                    clearMcpAuth={controller.clearMcpAuth}
                    showMcpRawConfig={controller.showMcpRawConfig}
                    setShowMcpRawConfig={controller.setShowMcpRawConfig}
